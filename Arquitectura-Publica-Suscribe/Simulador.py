...
#           +-------------------------+--------------------------+-----------------------+
#           |    create_acceleration  |     String: nombre       |  - Instancia la clase |
#           |        _sensor()        |                          |    SensorAcelerometro |
#           +-------------------------+--------------------------+-----------------------+
#           |    create_timer         |     String: nombre       |  - Instancia la clase |
#           |        _sensor()        |                          |    SensorTemporizador |
#           +-------------------------+--------------------------+-----------------------+
#           |                         |                          |  - Ejecuta los metodos|
...
from SensorTemporizador import SensorTemporizador
...
class SetUpSimulador:
    ...
    def main(self):
        ...
        print('|                      |     va en cualquiera |')
        print('|                      |     de los ejes del  |')
        print('|                      |     movimiento.      |')
        print('+----------------------+----------------------+')
        print('|    Tomar Medicina    |   - Hora en la que un|')
        print('|                      |     paciente debe to-|')
        print('|                      |     mar su medicina  |')
        print('|                      |                      |')
        print('+----------------------+----------------------+')
        print('')
        raw_input('presiona enter para continuar: ')
        ...
        for x in xrange(0, int(publishers)):
            ...
            print('+---------------------------------------------+')
            self.create_acceleration_sensor(nombre)
            print('|     SENSOR ACELERÓMETRO    |    ASIGNADO   |')
            print('+---------------------------------------------+')
            self.create_timer_sensor(nombre)
            print('|     SENSOR TEMPORIZADOR    |    ASIGNADO   |')
            print('+---------------------------------------------+')
            print('')
            raw_input('presiona enter para continuar: ')
        print('+---------------------------------------------+')
        ...
        self.aceleracion = int(aceleracion_maxima)
        print('+---------------------------------------------+')
        print('|         ACELERACIÓN        |      ' + aceleracion_maxima + '       |')
        print('+---------------------------------------------+')
        print('|        TEMPORIZADOR        |        ?       |')
        print('+---------------------------------------------+')
        temporizador_maximo = raw_input('temporizador máximo: ')
        self.tiempo = int(temporizador_maximo)
        print('+---------------------------------------------+')
        print('|        TEMPORIZADOR        |      ' + temporizador_maximo + '       |')
        print('+---------------------------------------------+')
    ...
    def create_acceleration_sensor(self, nombre):
        s = SensorAcelerometro(nombre)
        self.sensores.append(s)

    def create_timer_sensor(self, nombre):
        s = SensorTemporizador(nombre)
        self.sensores.append(s)
    ...
    def start_consumers(self):
        ...
        os.system(
            "gnome-terminal -e 'bash -c \"python AcelerometroManager.py " + str(self.aceleracion) + "; sleep 5 \"'")
        os.system(
            "gnome-terminal -e 'bash -c \"python TemporizadorManager.py " + str(self.tiempo) + "; sleep 5 \"'")
